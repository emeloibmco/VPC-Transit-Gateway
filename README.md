...
2. En la sección *connection*, en *remote host* colo su IP pública o flotante según sea el caso y el puerto 5901, de la siguiente manera: ```<IP>:5902```.
<p align="center"><img width="700" src="https://github.com/emeloibmco/VPC-acceso-VNC/blob/main/Imagenes/TightVNC.PNG"></p>
...
<p align="center"><img width="700" src="https://github.com/emeloibmco/VPC-acceso-VNC/blob/main/Imagenes/AccesoVNC.PNG"></p>
